...
- [zfoxer/foo_scrobbler_mac](https://github.com/zfoxer/foo_scrobbler_mac) - Native Last.fm scrobbler (foo_scrobbler_mac) for foobar2000 on macOS.
...
- [Massad/gin-boilerplate](https://github.com/Massad/gin-boilerplate) - The fastest way to deploy a RESTful API with Gin Framework — PostgreSQL, JWT auth, Redis, PDF generation, and Swagger docs out of the box.
...
- [simonrob/pyoslog](https://github.com/simonrob/pyoslog) - Send messages to the macOS unified logging system from Python
...
- [franfrandev/murph](https://github.com/franfrandev/murph) - A Huff &lt;&gt; bytecode transpiler
...
- [admonstrator/glinet-tailscale-updater](https://github.com/admonstrator/glinet-tailscale-updater) - Automated Tailscale updater for GL.iNet routers: periodically checks for new releases, downloads the correct build, and installs/updates Tailscale reliably via script (for OpenWrt/GL.iNet firmware)
...
- [astudentinearth/darkwrite](https://github.com/astudentinearth/darkwrite) - Notes as it should have been. Built for people who just want to write, without nonsense.
...
- [nivek-ph/blockchain-notes](https://github.com/nivek-ph/blockchain-notes) - 
...
- [namehash/namekit](https://github.com/namehash/namekit) - [ARCHIVED] Easily integrate rich ENS user journeys into your wallet, app, or game.
